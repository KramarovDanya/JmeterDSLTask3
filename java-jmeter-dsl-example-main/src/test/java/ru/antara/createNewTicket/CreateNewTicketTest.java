package ru.antara.createNewTicket;
...
public class CreateNewTicketTest {
    ...
    static final Logger logger = LogManager.getLogger(CreateNewTicketTest.class);
    ...
    private void test() throws IOException, InterruptedException, TimeoutException {
        ...
        TestPlanStats run = testPlan(
                ...
                getHeaders(),
                getHttpDefaults(),
                ChangeTicketThreadGroup.getThreadGroup("TG_Create_New_Ticket", debugEnable)
                        .children(
                                ...
                                transaction("UC_Create_New_Ticket",
