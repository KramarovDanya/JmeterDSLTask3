...
public class CreateUserTest {
    ...
    static final Logger logger = LogManager.getLogger(CreateUserTest.class);
    ...
    private void test() throws IOException, InterruptedException, TimeoutException {
        ...
        TestPlanStats run = testPlan(
                ...
                getHeaders(),
                getHttpDefaults(),
                ChangeTicketThreadGroup.getThreadGroup("TG_Create_New_User", debugEnable)
                        .children(
                                ...
                                transaction("UC_Create_New_User",
