package ru.antara.openTicketTest.fragments;

import org.apache.jmeter.protocol.http.util.HTTPConstants;
import ru.antara.common.interfaces.SimpleController;
import ru.antara.openTicketTest.postprocessors.OpenTicketCheck;
    ...
    public DslSimpleController get() {
        return simpleController(
                ...
                httpSampler("<__/tickets/${Random_ticket}/","/tickets/${Random_ticket}/")
                        .method(HTTPConstants.GET)
                        .children(regexExtractor("Check_ticket","(Submitter E-Mail)")
                                .defaultValue("Err_open_ticket"),jsr223PostProcessor(OpenTicketCheck.class))
