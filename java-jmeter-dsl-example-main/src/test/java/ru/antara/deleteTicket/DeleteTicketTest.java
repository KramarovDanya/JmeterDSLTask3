package ru.antara.deleteTicket;
...
import ru.antara.deleteTicket.samplers.DeleteTicketThreadGroup;
...
public class DeleteTicketTest {
    ...
    private void test() throws IOException, InterruptedException, TimeoutException {
        ...
        TestPlanStats run = testPlan(
                ...
                getHeaders(),
                getHttpDefaults(),
                DeleteTicketThreadGroup.getThreadGroup("TG_Delete_Ticket", debugEnable)
                        .children(
