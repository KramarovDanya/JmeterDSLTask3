...
public class PaginationTest {
    ...
    static final Logger logger = LogManager.getLogger(PaginationTest.class);
    ...
    private void test() throws IOException, InterruptedException, TimeoutException {
        ...
        TestPlanStats run = testPlan(
                ...
                getHeaders(),
                getHttpDefaults(),
                PaginationThreadGroup.getThreadGroup("TG_Pagination", debugEnable)
                        .children(
